...
**
** Created: Thu Feb 16 20:58:50 2012
...
void reportLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        reportLayout *_t = static_cast<reportLayout *>(_o);
        switch (_id) {
        case 0: _t->goExit(); break;
        case 1: _t->dbListClicked((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->layoutListClicked((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->getReportListItemsCb((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData reportLayout::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject reportLayout::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_reportLayout,
      qt_meta_data_reportLayout, &staticMetaObjectExtraData }
};
