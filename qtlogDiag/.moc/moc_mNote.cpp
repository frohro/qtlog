...
**
** Created: Thu Feb 16 20:58:57 2012
...
void mNote::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        mNote *_t = static_cast<mNote *>(_o);
        switch (_id) {
        case 0: _t->updateNoteItem((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->deleteNoteItem(); break;
...
const QMetaObjectExtraData mNote::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mNote::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_mNote,
      qt_meta_data_mNote, &staticMetaObjectExtraData }
};
